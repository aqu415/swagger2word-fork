...
2. swagger2Word 提供了多种方式生成 word 文档
   1. 可以通过 swagger json 的资源地址，例如：https://petstore.swagger.io/v2/swagger.json
   2.   可以通过上传 json 文件；甚至可以直接输入 json 字符串。  
   
![Image text](./swagger2word.jpg)

3. 生成的 WORD 示例：  
![Image text](./demo_word.jpg)
